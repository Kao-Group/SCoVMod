...
public class MildInfectiousToRecoveredTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.getMiToR_YoungRate()).thenReturn(MI_TO_R_RATE);

        MildInfectiousToRecoveredTransitionExecutor instance = new MildInfectiousToRecoveredTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToR_AdultRate()).thenReturn(MI_TO_R_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getMiToR_ElderlyRate()).thenReturn(MI_TO_R_RATE);
