...
public class SevereInfectiousToRecoveredTransitionExecutorTest {
    ...
    public void youngPerson_CAN_Transition(){
        ...
        when(params.getSiToR_YoungRate()).thenReturn(SI_TO_R_RATE);

        SevereInfectiousToRecoveredTransitionExecutor instance = new SevereInfectiousToRecoveredTransitionExecutor(sm, rnd, TIMESTEP, params,slaac);
    ...
    public void adultPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getSiToR_AdultRate()).thenReturn(SI_TO_R_RATE);
    ...
    public void elderlyPerson_CAN_Transition(){
        ...
        when(slaac.getPeopleAgeClasses()).thenReturn(peopleAgeClasses);
        when(params.getSiToR_ElderlyRate()).thenReturn(SI_TO_R_RATE);
