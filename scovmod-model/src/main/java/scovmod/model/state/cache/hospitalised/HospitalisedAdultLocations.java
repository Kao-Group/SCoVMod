...
import static scovmod.model.state.infection.InfectionState.HOSPITALISED_ADULT;

public class HospitalisedAdultLocations implements Cache {

    IntSet locations = new IntOpenHashSet();

    public void wholeLocationUpdate(int locationId, LocalPopulation population) {
        if (!population.getAllInState(HOSPITALISED_ADULT).isEmpty()) {
    ...
    public IntSet getHospitaliseAdultLocations() {
